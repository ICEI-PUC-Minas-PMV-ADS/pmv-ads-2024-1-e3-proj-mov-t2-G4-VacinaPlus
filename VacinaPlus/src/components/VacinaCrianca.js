...
const vaccineItems = [
    ...
    { title: 'Pentavalente (DTP/HB/Hib)', description: '1a dose' },
    { title: 'VIP (Poliomielite inativada)', description: '1a dose' },
    { title: "Pneumocócica 10V", description: "1a dose" },
    { title: "Vacina rotavirus humano G1P1", description: "1a dose" },
    { title: "Meningocócica C conjugada", description: "2a dose" },
    { title: "Pentavalente (DTP/HB/Hib)", description: "2a dose" },
    { title: "VIP (Poliomielite inativada)", description: "2a dose" },
    { title: "Pneumocócica 10V ", description: "2a dose" },
    { title: "Vacina rotavirus humano G1P1", description: "2a dose" },
    { title: "Meningocócica C conjugada", description: "2a dose" },
    { title: "Pentavalente (DTP/HB/Hib)", description: "3a dose" },
    { title: "VIP (Poliomielite inativada)", description: "3a dose" },
    { title: "Pneumocócica 10V ", description: "2a dose" },
    { title: "Febre amarela", description: "Dose única" },
    { title: "Pneumocócica 10 Valente", description: "Reforço" },
    { title: "Tríplice Viral", description: "1a dose" },
    { title: "Hepatite A", description: "Dose única" },
    { title: "Poliomielite oral VOP", description: "1° reforço" },
    { title: "DTP", description: "1° reforço" },
    { title: "Tetra viral oo tríplice viral + varicela", description: "Dose única" },
    { title: "DTP", description: " 2° reforço" },
    { title: "Vacina Oral Poliomielite (VOP)", description: "2° reforço" },
